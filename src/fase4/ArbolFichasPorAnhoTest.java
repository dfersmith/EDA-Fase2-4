...
public class ArbolFichasPorAnhoTest extends TestCase  {
	...
	public ArbolFichasPorAnhoTest(String string) {
		super(string);
		armario = new Armario();
	...
	/**
     * Test of mostrarArbol method, of class ArbolFichasPorAnho.
     */
    @Test
    public void testMostrarArbol() {
    	System.out.println("mostrarArbol");
		ColeccionFichas cFichas = new ColeccionFichas(armario);
		ArbolFichasPorAnho instance = new ArbolFichasPorAnho(cFichas);
    ...
    /**
     * Test of mostrarFichasPropietario method, of class ArbolFichasPorAnho.
     */
    @Test
    ...
    /**
     * Test of mostrarFichasRango method, of class ArbolFichasPorAnho.
     */
    @Test
	...
	{
		TestSuite suite = new TestSuite("ArbolFichasPorAnho");
		
		TestSuite suiteB = new TestSuite("suiteMostrarArbol");
		TestSuite suiteC = new TestSuite("suiteMostrarFichasPropietario");
		TestSuite suiteD = new TestSuite("suiteMostrarFichasRango");
		
		
		suiteB.addTest(new ArbolFichasPorAnhoTest("testMostrarArbol"));
		suiteC.addTest(new ArbolFichasPorAnhoTest("testMostrarFichasPropietario"));
		suiteD.addTest(new ArbolFichasPorAnhoTest("testMostrarFichasRango"));
